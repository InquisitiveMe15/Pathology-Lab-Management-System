...
app.config['MYSQL_DATABASE_PASSWORD'] = 'KHU1*ver' # default passwrod of MySQL to be replaced with appropriate password
app.config['MYSQL_DATABASE_DB'] = 'customersdb'  # Database name to be replaced with appropriate database name
